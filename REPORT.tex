...
The simulation of the proposed obstacle detection and collision avoidance algorithm is carried out through two different approaches: a linear simulation approach and another simulation method using MATLAB and Paparazzi NPS simulator.
\input{Yazdi_sim}
\input{Seong_sim}
